...
contract Shop is ERC20, Ownable {
    ...
    constructor(string memory name, string memory symbol, string memory _shopWebsite, string memory _shopAddress, string memory _shopPhoneNumber) ERC20(name, symbol) {
    ...
    function updateMetadata(string memory _shopWebsite, string memory _shopAddress, string memory _shopPhoneNumber) public onlyOwner {
        shopWebsite = _shopWebsite;
        shopAddress = _shopAddress;
        shopPhoneNumber = _shopPhoneNumber;
    }
